...
setting('infill_percentage',               12, float, 'basic',    _('Fill')).setExpertSubCategory(_('Infill')).setRange(0, 100).setLabel(_("Infill percentage"), _("This is not a user editable field. To change infill change infill distance."))
...
setting('show_infill', False, bool, 'expert', _('Infill')).setLabel(_("Show infill"), _("You will be able to see the infill pattern at the base plate."))
