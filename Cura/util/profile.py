...
setting('dsvXaxis', 'Layer Height', [_('-'),('Layer Height'), _('Infill'), _('Wall Thickness'),_('Print Speed')], 'dsvpreference', 'hidden').setLabel(_('X Axis'), _('Select the first variable for DSV.'))
setting('dsvYaxis', 'Layer Height', [_('-'),_('Layer Height'), _('Infill'), _('Wall Thickness'),_('Print Speed')], 'dsvpreference', 'hidden').setLabel(_('Y Axis'), _('Select the second variable for DSV.'))
