...
setting('show_infill',              False, bool, 'basic', _('Fill')).setLabel(_("Show infill"), _("You will be able to see the infill pattern before slicing. \nOnly Line and Grid infill are visualized."))
