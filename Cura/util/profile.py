...
setting('infill_percentage',               12, float, 'basic',    _('Fill')).setRange(0, 100).setLabel(_("Infill percentage"), _("This is not a user editable field. To change infill change infill distance."))
