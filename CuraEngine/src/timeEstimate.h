...
public:
    ...
    public:
		...
		double max_feedrate[TimeEstimateCalculator::NUM_AXIS] = {500, 500, 500, 12};
		double minimumfeedrate = 0.01;
		double acceleration = 1900;
		double max_acceleration[TimeEstimateCalculator::NUM_AXIS] = {981,981,981,981};
		double max_xy_jerk = 15.0;
		double max_z_jerk = 5;
