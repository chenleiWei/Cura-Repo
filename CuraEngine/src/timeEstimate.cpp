...
const double max_feedrate[TimeEstimateCalculator::NUM_AXIS] = {500, 500, 500, 12};
const double minimumfeedrate = 0.01;
const double acceleration = 1900;
const double max_acceleration[TimeEstimateCalculator::NUM_AXIS] = {981,981,981,981};
const double max_xy_jerk = 15.0;
const double max_z_jerk = 5;
